...
{
    /**
    * Key that allows the supplier account purchase order line record to be uniquely identified and linked to.
    */
    public String keyOrderPurchaseLineID = new String();
    ...
    */
    ...
    /**
    * Defines the type of data that the line represents. Set it to one of the constants prefixed with RECORD_LINE_TYPE_ in the ESDocumentConstants class
    */
