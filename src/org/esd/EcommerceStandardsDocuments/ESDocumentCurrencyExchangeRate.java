...
*  }
*/
public class ESDocumentCurrencyExchangeRate  extends ESDocument 
{
    /**
    * List of currency exchange rate records
    */
    public ESDRecordCurrencyExchangeRate[] dataRecords = new ESDRecordCurrencyExchangeRate[]{};
    
    /**
    * Constructor
    * Creates a new Ecommerce Standards document instance
    */
    public ESDocumentCurrencyExchangeRate(){
    }
    
    /**
    * Constructor
    *  @param resultStatus status of obtaining the currency exchange rate data
    *  @param message message to accompany the result status
    *  @param currencyExchangeRates list of currency exchange rate records
    *  @param configs A list of key value pairs that contain additional information about the document.
    */
    public ESDocumentCurrencyExchangeRate(int resultStatus, String message, ESDRecordCurrencyExchangeRate[] currencyExchangeRates, HashMap<String, String> configs){
        ...
        {
            this.totalDataRecords = currencyExchangeRates.length;
        }    
    }
}
