...
*/
public class ESDRecordPaymentSurcharge
{
    /**
    * List of tax records applied to the surcharge.
    */
    public ArrayList<ESDRecordPaymentTax> taxes = new ArrayList<ESDRecordPaymentTax>();

    /**
    * Key of the surcharge record that the customer account payment surcharge record is linked to.
    */
    ...
    */
    ...
    /**
    * Language that the descriptive text of the surcharge is in. Set it to a constant prefixed with LANG_ in the ESDocumentConstants class
    */
    ...
    */
    public void setDefaultValuesForNullMembers(){
        if (taxes == null)
        {
            taxes = new ArrayList<ESDRecordPaymentTax>();
        }
        else
        {
            for (ESDRecordPaymentTax tax : taxes)
            {
