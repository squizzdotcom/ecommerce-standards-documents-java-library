...
* }
*/
public class ESDocumentSupplierAccountEnquiry  extends ESDocument 
{
    /**
    * list of Supplier Account Enquiry Order Purchase records.
    */
	@JsonInclude(JsonInclude.Include.ALWAYS)
    public ESDRecordSupplierAccountEnquiryOrderPurchase[] orderPurchaseRecords = new ESDRecordSupplierAccountEnquiryOrderPurchase[]{};
    ...
    */
    public ESDocumentSupplierAccountEnquiry(int resultStatus, String message, HashMap<String, String> configs){
