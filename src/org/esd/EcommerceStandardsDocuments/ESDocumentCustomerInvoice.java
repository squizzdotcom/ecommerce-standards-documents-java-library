...
* }
*/
public class ESDocumentCustomerInvoice  extends ESDocument 
{
    /**
    * List of customer invoice records
    */
	@JsonInclude(JsonInclude.Include.ALWAYS)
    public ESDRecordCustomerInvoice[] dataRecords = new ESDRecordCustomerInvoice[]{};
    
    /**
    * Constructor
    * Creates a new Ecommerce Standards document instance
    */
    public ESDocumentCustomerInvoice(){
    }
    
    /**
    * Constructor
    *  @param resultStatus status of obtaining the customer invoice data
    *  @param message message to accompany the result status
    *  @param customerInvoices list of customer invoice records
    *  @param configs A list of key value pairs that contain additional information about the document.
    */
    public ESDocumentCustomerInvoice(int resultStatus, String message, ESDRecordCustomerInvoice[] customerInvoices, HashMap<String, String> configs){
