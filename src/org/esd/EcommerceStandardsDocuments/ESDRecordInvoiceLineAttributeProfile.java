...
{
    /**
    * Key of the invoice attribute profile record
    */
    public String keyAttributeProfileID = new String();

    /**
    * Code of the attribute profile. May or may not be a unique identifier.
    */
    ...
    */
    ...
    /**
    * List of attributes and values for the invoice attribute profile
    */
    public ArrayList<ESDRecordInvoiceLineAttribute> values = new ArrayList<ESDRecordInvoiceLineAttribute>();
    ...
    */
    public void setDefaultValuesForNullMembers(){
        if (values== null)
        {
            values = new ArrayList<ESDRecordInvoiceLineAttribute>();
        }
        else
        {
            for (ESDRecordInvoiceLineAttribute attributeValue : values)
            {
