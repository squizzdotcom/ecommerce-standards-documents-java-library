...
public class ESDocumentType 
{
	...
	public static final int GENERAL_LEDGER_ACCOUNT = 43;
    public static final int IMAGE = 12;
    public static final int ITEM_GROUP = 34;
    public static final int ITEM_RELATION = 14;
    ...
    public static final int PRICE_LEVEL = 2;
    public static final int PRODUCT = 3;
    public static final int PRODUCT_COMBINATION = 15;
    public static final int PURCHASER = 25;
    public static final int SALES_REP = 16;
    public static final int SELL_UNIT = 28;
