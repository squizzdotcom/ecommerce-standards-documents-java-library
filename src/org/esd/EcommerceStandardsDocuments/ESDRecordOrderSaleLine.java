...
public class ESDRecordOrderSaleLine   
{
    ...
    */
    ...
    /**
    * Code of the line in the purchase order associated to the sales order.
    */
    public String purchaseOrderLineCode = new String();

    /**
    * number of the line in the purchase order associated to the sales order.
    */
    ...
    */
    public void setDefaultValuesForNullMembers(){
        ...
        {
            for (ESDRecordOrderProductDelivery productDelivery : productDeliveries)
            {
        ...
        {
            for (ESDRecordOrderLineAttributeProfile productAttributeProfile : attributes)
            {
