...
* }
*/
public class ESDocumentOrderSale  extends ESDocument 
{
    /**
    ...
    *  @param salesOrderRecords list of sales order records
    *  @param configs A list of key value pairs that contain additional information about the document.
    */
    public ESDocumentOrderSale(int resultStatus, String message, ESDRecordOrderSale[] salesOrderRecords, HashMap<String, String> configs){
