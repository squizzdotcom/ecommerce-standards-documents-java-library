...
{
    /**
    * Key that allows the customer account quote line record to be uniquely identified and linked to.
    */
    public String keyQuoteLineID = new String();
    ...
    */
    ...
    /**
    * Quantity quoted for the line.
    */
    public double quantityQuoted = 0;
