...
public class ESDRecordCustomerAccountEnquiryQuote {
    ...
    */
    ...
    /**
    * Name of the contact person at the address that the quoted goods are being delivered to
    */
    public String deliveryContact = new String();

    /**
    * Name of the organisation that the quoteed goods are being delivered to
    */
    ...
    */
    ...
    /**
    * Code of the country at the address that the quoted goods are being delivered to as a 2 digit code set by ISO standards.
    */
    public String deliveryCountryCodeISO2 = new String();

    /**
    * Code of the country at the address that the quoted goods are being delivered to as a 3 digit code set by ISO standards.
    */
    public String deliveryCountryCodeISO3 = new String();


    /**
    * Post code of the address that the quoteed goods are being delivered to
    */
    ...
    */
    ...
    /**
    * Name of the organisation that the quotes goods are being billed to
    */
    ...
    */
    ...
    /**
    * Total monetary amount of tax applied to the sale quote's total
    */
    ...
    */
    ...
    /**
    * Code of the freight carrier who delivered the quoted goods
    */
    public String freightCarrierCode = new String();

    /**
    * Name of the freight carrier who delivered the quotes goods
    */
    ...
    */
    ...
    /**
    * Consignment code issued by the freight carrier to delivery the quoted goods
    */
    public String freightCarrierConsignCode = new String();

    /**
    * Code to track the freight carrier who delivered the quoted goods
    */
    public String freightCarrierTrackingCode = new String();

    /**
    * Code of the service provided by the freight carrier to deliver the quoted goods
    */
    ...
    */
    public ESDRecordCustomerAccountEnquiryQuoteLine[] lines = new ESDRecordCustomerAccountEnquiryQuoteLine[]{};
}
