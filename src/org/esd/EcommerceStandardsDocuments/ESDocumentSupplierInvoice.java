...
* }
*/
public class ESDocumentSupplierInvoice  extends ESDocument 
{
    /**
    * List of supplier invoice records
    */
    ...
    */
    public ESDocumentSupplierInvoice(){
    }
    
    /**
    * Constructor
    *  @param resultStatus status of obtaining the supplier invoice data
    *  @param message message to accompany the result status
    *  @param supplierInvoices list of supplier invoice records
    *  @param configs A list of key value pairs that contain additional information about the document.
    */
    public ESDocumentSupplierInvoice(int resultStatus, String message, ESDRecordSupplierInvoice[] supplierInvoices, HashMap<String, String> configs){
